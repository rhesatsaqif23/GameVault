  ...
  return (
    <div className="relative w-full md:w-80 group">
      ...
      <input 
        ...
        className="w-full pl-10 pr-4 py-2.5 bg-card border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 text-sm font-medium"
      />
    </div>
  );
};
